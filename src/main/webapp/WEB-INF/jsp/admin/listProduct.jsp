...
<div class="panel panel-warning" align="center"style="width: 500px;margin: auto">
    ...
    <div class="panel-body">
        <form id="addForm" action="admin_product_add?cid=${c.id}" method="post" enctype="multipart/form-data">
            <table class="table">
                <tr>
                    <td>姓名</td>
                ...
                <tr>
                    <td>图片</td>
                    <td><input type="file" class="form-control-static" accept="image/*" id="picture" name="picture"></td>
                </tr>
                <tr>
